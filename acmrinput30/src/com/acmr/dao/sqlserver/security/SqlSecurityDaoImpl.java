...
public class SqlSecurityDaoImpl implements ISecurityDao {
	...
	public DataTable getUsers(String depcode) {
		String sql1 = "select * from tb_right_user where ifclose='0' and  depcode=? order by userid";
		return AcmrInputDPFactor.getQuickQuery().getDataTableSql(sql1, new String[] { depcode });
	}
