...
public class SqlFlowIndexDaoImpl implements IFlowIndexDao {
	...
	public String insertFlowIndex(FlowIndex flowIndex) {
		...
		sql.append("(cname,flowdata,createtime,memo,version)");
	...
	private String insertFlowNode(FlowNode flowNode) {
		StringBuffer sql = new StringBuffer();
		sql.append("insert into tb_flow_node(flowcode,nodedata,sort,type,version)");
		sql.append(" values(?,?,?,?,?)");
	...
	private String insertFlowPerson(FlowPerson flowPerson) {
		StringBuffer sql = new StringBuffer();
		sql.append("insert into tb_flow_person (nodeid,type,proleid,version)");
		sql.append(" values(?,?,?,?)");
		Object[] prams = new Object[4];
