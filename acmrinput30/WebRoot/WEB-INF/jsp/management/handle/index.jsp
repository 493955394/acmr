			...
			<div class="col-md-2" style="height: 570px;overflow:auto;background: #f6f9fe">
			    ...
			    <div style="margin-top:20px;">
				    <div class="list-group">	
				    	<a href="${ctx}/system/handle.htm?m=findDimension" class="list-group-item <c:if test="${type =='dimension'}">active</c:if>">维度反馈</a>
				    	<a href="${ctx}/system/handle.htm?m=findSynonym" class="list-group-item <c:if test="${type =='synonym'}">active</c:if>">同义词反馈</a>
				    </div>
			    </div>
			</div>
			<div class="col-md-10">
