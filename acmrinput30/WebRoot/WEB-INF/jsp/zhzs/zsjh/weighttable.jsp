   ...
   // console.log("${module.getCname()}")
    ...
    if (flag==rows){
        $("#"+"${module.getProcode()}").after(
            "<td rowspan=${module.ZBnums()}>${module.getCname()}</td><td id=${module.getCode()} rowspan=${module.ZBnums()} flag=${module.ZBnums()}>权重：<input pcode='${module.getProcode()}' class='input_weight' value='${module.getWeight()}'></td>"
        )
    ...
    //与父节点不同行
        ...
        $("#"+"${module.getProcode()}").parent().nextAll(":eq(" +
            (rows-flag-1)+")").append("<td rowspan=${module.ZBnums()}>${module.getCname()}</td><td id=${module.getCode()} rowspan=${module.ZBnums()} flag=${module.ZBnums()}>权重：<input pcode='${module.getProcode()}' class='input_weight' value='${module.getWeight()}'></td>")
    ...
    if (flag==rows){
        $("#"+"${module.getProcode()}").after(
            "<td>${module.getCname()}</td><td id=${module.getCode()}>权重：<input pcode='${module.getProcode()}' class='input_weight' value='${module.getWeight()}'>公式：<input value='${module.getFormula()}' readonly></td>"
        )
    ...
    //与父节点不同行
        ...
        //$("#"+"${module.getProcode()}").parent().nextAll(":eq(1)").append("<td>test</td>")
        $("#"+"${module.getProcode()}").parent().nextAll(":eq(" +
            (rows-flag-1)+")").append("<td>${module.getCname()}</td><td id=${module.getCode()} >权重：<input pcode='${module.getProcode()}' class='input_weight' value='${module.getWeight()}'>公式：<input value='${module.getFormula()}' readonly></td>")
        $("#"+"${module.getProcode()}").attr("flag",flag-1)
    }
    </c:if>
    </c:forEach>
