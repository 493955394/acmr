...
<html>
	<head>
		<meta charset="UTF-8">
		<title>${projectTitle}-地区管理-新增</title>
		...
		<div class="container-fluid">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form class="form-horizontal J_add_form" action="${ctx}/metadata/regmgr.htm?m=toSave">
						...
						<div class="form-group">
							<label class="col-sm-2 control-label"><span class="glyphicon glyphicon-asterisk required_ico"></span>地区代码</label>
							<div class="col-sm-5">
	...
	<script type="text/javascript">
		seajs.use('${ctx}/js/func/metadata/regmgr/add');
	</script>
</body>
</html>