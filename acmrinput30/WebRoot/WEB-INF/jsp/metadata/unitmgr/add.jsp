...
<html>
	<head>
		<meta charset="UTF-8">
		<title>${projectTitle}-单位管理-增加</title>
				...
				<div class="panel-body">
					<form class="form-horizontal J_add_form" action="${ctx}/metadata/unit.htm?m=add">
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<textarea rows="" cols="" class="form-control" name="rate" onkeyup="value=value.replace(/[^\d.]/g,'')"></textarea>
							</div>
						</div>
						<div class="form-group">
	...
	<script type="text/javascript">
		seajs.use('${ctx}/js/func/metadata/unitmgr/add');
	</script>
</body>
</html>