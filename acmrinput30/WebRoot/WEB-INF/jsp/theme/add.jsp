...
<head>
<meta charset="UTF-8">
<title>${projectTitle}-栏目管理-添加模块</title>
	...
	<div class="container-fluid">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form class="form-horizontal J_add_form" method="post" enctype="multipart/form-data" action="${ctx}/theme/theme.htm?m=toSave">
						...
						<div class="col-sm-5">
							<select class="form-control" name="fl" autocomplete="off">
								<c:forEach items="${tree}" var="list">
									<option value="${list.code}" <c:if test="${list.code eq procodeId}">selected</c:if> >${list.cname}</option>
								</c:forEach>
							</select>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<textarea rows="" cols="" class="form-control" name="exp"></textarea>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="radio-inline">
                           <label>
                               <input type="radio" name="visible" autocomplete="off" checked="checked" value="0">所有用户均可见
                           </label>
						</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<div class="radio-inline col-sm-10">
	                           <label>
	                               <input type="radio" name="visible" autocomplete="off" value="1">仅以下组织/用户/角色可查看
	                           </label>
	                        </div>
	                        
							<div class="col-sm-2">
								<buttom class="btn btn-primary btn-sm J_addPower hide">新增权限</buttom>
	                        </div>
                        </div>
					</div>
					
					<div class="form-group J_power hide">
						<label class="col-sm-2 control-label"></label>
...
<script type="text/javascript">
	seajs.use('${ctx}/js/func/theme/add');
</script>
</body>
</html>