define(function (require,exports,module) {
    ...
    var rootNode = [{"id":"","name":"指数结构",pId:"", "open":"true", "isParent":"true",icon:"../css/img/mark1.png"}];
    ...
    function deleteMod(){
        console.log("delete")
        var modcode=$(this).parent().prevAll()[4].innerHTML
    ...
    function upmove(){
        ...
        var thiscode=$(this).parent().prevAll()[4].innerHTML
    ...
    function jumpedit() {
        var code = $(this).parent().prevAll()[4].innerHTML
