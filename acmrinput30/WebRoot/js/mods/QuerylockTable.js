	...
	(function($){
	    ...
	    yfjs.yflockTable.prototype = {
	            ...
	            this.$applyTo.append(
	                    '<div class="lockTable_container" style="width: '+this.width+'px; height: '+this.height+'px;overflow: hidden;position: relative;">' +
	                        ...
	                        '<div class="table_container_column" style="overflow: hidden;position: absolute;z-index: 40;top:0;left:0;"></div>'+
	                         '<div class="table_container_main" style="overflow: auto;width: '+this.width+'px;height: '+this.height * 0.8+'px;"></div>'+
	        ...
	        setHtmlCss : function(){
	            ...
	            this.tableColumn.css({"height":this.height * 0.8-17,"width":lockWidth-width}).children("table").css({"width":this.width-width});
