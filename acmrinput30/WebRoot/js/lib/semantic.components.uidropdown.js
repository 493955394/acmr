...
(function($, window, document, undefined) {
    ...
    $allModules
      .each(function(elementIndex) {
        ...
        module = {
            ...
            item: {
              ...
              click: function(event) {
                ...
                if (!isBubbledEvent && (!hasSubMenu || settings.allowCategorySelection)) {
                  ...
                  $searchMenu && $searchMenu.transition('hide');
                  $treeMenu && $treeMenu.transition('show');
                }
              }
            },
            located: {
                    ...
                    onSuccess: function(response) {
                      var tree,
                        ...
                        treeSetting = {
                          ...
                          callback: {
                            onClick: settings.treeClickEvent
                          }
                        };
                  ...
                  if (isMultiple) {
                    if (!isActive || isUserValue) {
                      ...
                      if (settings.useLabels) {
                        ...
                        module.add.label(selectedValue, selectedText, shouldAnimate, $selected);
          ...
          add: {
            label: function(value, text, shouldAnimate, $selectedItem) {
              var
              ...
              $label = $('<a />')
                ...
                .attr('data-type', $selectedItem.data('type'))
  ...
  $.fn.uidropdown.settings = {
    ...
    treeWidget:'',
    posi: false,
    treeClickEvent: function(event, treeId, treeNode) {},
    param:[],
  ...
  $.fn.uidropdown.settings.templates = {
    ...
    menu: function(response, fields) {
      ...
      $.each(values, function(index, option) {
        ...
        if($.fn.uidropdown.settings.posi){
          html += '<i class="marker blue icon" id="' + option[fields.value] + '"></i>';
        }
        html += '<i class="linkify right floated blue icon" title="' + option[fields.path] + '"></i><label>' + option[fields.name] + '</label></div>';
      });
      return html;
    },
