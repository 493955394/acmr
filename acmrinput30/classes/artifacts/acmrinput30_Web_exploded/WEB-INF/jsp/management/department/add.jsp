...
<html>
	<head>
		<meta charset="UTF-8">
		<title>${projectTitle}-组织管理-新增</title>
	...
	<body>
		...
		<div class="container-fluid J_main_container">
			<div class="panel panel-default">
				<div class="panel-heading">新增组织</div>
				<div class="panel-body">
					<form class="form-horizontal J_add_form" action="${ctx}/system/dep.htm?m=insert">
	...
	seajs.use('${ctx}/js/func/management/department/add');
	</script>
</body>
</html>