...
<html>
	...
	<body>
		...
		<div class="container-fluid" id="mainpanel">
			<div class="col-md-2 left-panel">
			    <div class="panel tree-panel">
			        <div class="panel-heading">主体树</div>
			    </div>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="toolbar-left">
							<form class="form-inline J_search_form" action="${ctx}/metadata/company.htm?m=find">
								<div class="form-group">
									<select id="querykey" class="form-control input-sm">
										<option value="code" <c:if test="${code != '' && code!= null}">selected</c:if>>主体代码</option>
										<option value="cname" <c:if test="${cname != '' && cname != null}">selected</c:if>>主体名称</option>
									</select>
								</div>
								<div class="form-group">
					...
					<div class="J_zbmgr_data_table">
						<jsp:include page="/WEB-INF/jsp/metadata/company/tableList.jsp" flush="true"/>
					</div>
				</div>
			</div>
		</div> 
		...
		<script type="text/javascript">
			seajs.use('${ctx}/js/func/metadata/company/main');
		</script>
	</body>
</html>