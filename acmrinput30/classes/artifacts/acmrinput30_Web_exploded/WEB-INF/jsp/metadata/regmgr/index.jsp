...
<html>
	...
	<body>
			...
			<div class="col-md-10 right-panel">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="toolbar-right">
							<div class="toolbar-group" style="position: relative;">
								...
								<a href="" class="btn btn-default btn-sm J_grade_search">高级查询</a>
					...
					<div class="J_regmgr_data_table">
						<jsp:include page="/WEB-INF/jsp/metadata/regmgr/tableList.jsp" flush="true"/>
					</div>
					<!-- 
					<div class="toolbar-right">
			            <ul class="pagination">
			            	...
			            	<c:forEach begin="2" end="4" varStatus="i">
				            	<c:if test="${page.pageNum+i.index-1 <= page.totalPage}">
				            		<li><a href="${ctx}/regmgr.htm?m=query&pageNum=${page.pageNum+i.index-1}">${i.index}</a></li>
								</c:if>
			            	</c:forEach>
			            	<c:choose>
			            		...
			            		<c:otherwise>
					            	<li><a href="${ctx}/regmgr.htm?m=query&pageNum=${page.pageNum+1}">下一页</a></li>
					            	<li><a href="${ctx}/regmgr.htm?m=query&pageNum=${page.totalPage}">末页</a></li>
			            		</c:otherwise>
			            	</c:choose>
			            </ul>
			        </div>
		...
		<script type="text/javascript">
			seajs.use('${ctx}/js/func/metadata/regmgr/main');
		</script>
	</body>
</html>