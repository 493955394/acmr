...
<html>
	<head>
		<meta charset="UTF-8">
		<title>${projectTitle}-单位管理-修改</title>
	...
	<body>
		...
		<div class="container-fluid">
			<div class="panel panel-default">
				<div class="panel-heading">修改单位</div>
				<div class="panel-body">
					<form class="form-horizontal J_edit_form" action="${ctx}/metadata/unit.htm?m=add">
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="text" class="form-control"value="${proname}" id="procodeName" readonly>
							</div>
						</div>
						<div class="form-group">
	...
	<script type="text/javascript">
		seajs.use('${ctx}/js/func/metadata/unitmgr/edit');
	</script>
</body>
</html>