...
<html>
	<head>
		<meta charset="UTF-8">
		<title>${projectTitle}-分组管理-添加</title>
	...
	<body>
		...
		<div class="container-fluid">
			<div class="panel panel-default">
				<div class="panel-heading">添加指标分组</div>
				<div class="panel-body">
					<form class="form-horizontal J_add_form" action="${ctx}/metadata/zbgmgr.htm?m=toSave">
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="text" class="form-control" name="procode" value="${procode}" readonly>
							</div>
						</div>
						
						<div class="form-group">
							<label class="col-sm-2 control-label"><span class="glyphicon glyphicon-asterisk required_ico"></span>指标分组代码</label>
							<div class="col-sm-5">
	...
	<script type="text/javascript">
		seajs.use('${ctx}/js/func/metadata/zbgmgr/add');
	</script>
</body>
</html>