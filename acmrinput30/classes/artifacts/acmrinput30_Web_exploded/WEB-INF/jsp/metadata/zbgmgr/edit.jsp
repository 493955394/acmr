...
<html>
	<head>
		<meta charset="UTF-8">
		<title>${projectTitle}-分组管理-修改</title>
	...
	<body>
		...
		<div class="container-fluid">
			<div class="panel panel-default">
				<div class="panel-heading">修改指标分组</div>
				<div class="panel-body">
					<form class="form-horizontal J_edit_form" action="${ctx}/metadata/zbgmgr.htm?m=toSave">
						...
						<div class="form-group">
							<label class="col-sm-2 control-label">指标分组代码</label>
							<div class="col-sm-5">
	...
	<script type="text/javascript">
		seajs.use('${ctx}/js/func/metadata/zbgmgr/edit');
	</script>
</body>
</html>