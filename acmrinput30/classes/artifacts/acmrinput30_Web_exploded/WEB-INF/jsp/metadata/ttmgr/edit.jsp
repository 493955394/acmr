...
<html>
	<head>
		<meta charset="UTF-8">
		<title>${projectTitle}-时间类型管理-修改</title>
	...
	<body>
		...
		<div class="container-fluid">
			<div class="panel panel-default">
				<div class="panel-heading">修改时间类型</div>
				<div class="panel-body">
					<form class="form-horizontal J_edit_form" action="${ctx}/metadata/datetype.htm?m=add">
	...
	<script type="text/javascript">
		seajs.use('${ctx}/js/func/metadata/ttmgr/edit');
	</script>
</body>
</html>