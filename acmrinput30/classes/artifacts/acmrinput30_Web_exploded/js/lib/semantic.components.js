                     ...
                     fetch: {
                         content: function(t, a) {
                             var i, o, r = v.get.tabElement(t),
                                 ...
                                 l = c && "pending" === c.state();
                             a = a || t, o = v.cache.read(a), T.cache && o ? (v.activate.tab(t), v.debug("Adding cached content", a), "once" == T.evaluateScripts ? v.update.content(t, o, !1) : v.update.content(t, o), T.onLoad.call(r[0], t, m, y)) : l ? (v.set.loading(t), v.debug("Content is already loading", a)) : e.api !== n ? (i = e.extend(!0, {
                                 headers: {
                                     "X-Remote": !0
                                 }
                             }, T.apiSettings, s), v.debug("Retrieving remote content", a, i), r.api(i)) : v.error(P.api)
                         }
                     },
                     activate: {
                         all: function(e) {
...
$.fn.modal.settings = {
  ...
  className : {
    ...
    undetached : 'undetached'
     ...
     /*!
      * # Semantic UI 2.1.6 - Dropdown-tree
      */
                                     ...
                                     var
                                         ...
                                         apiSettings = {
                                             ...
                                             onSuccess: function(response) {
                                                 ...
                                                 $.fn.zTree.init($("#outArgTree"), treeSetting, response.results);
                                                 tree = $.fn.zTree.getZTreeObj('outArgTree');
    ...
    selector: {
      ...
      item: '.item > label, #outArgTree li a:not(.disabled), #wdOutArgTree li a:not(.disabled)', //#demo li a
      label: '> .label',
                 ...
                 C = {
                     ...
                     can: {
                         transition: function(e) {
                             var i, a, o, r, s, l, u, d = f.animation,
                                 c = C.get.transitionExists(d);
                             if (c === t || e) {
     ...
     ! function(e, t, r, n) {
         ...
         e.api = e.fn.api = function(r) {
             ...
             return s.each(function() {
                 var s, g, f, m, p, b, v = e.isPlainObject(r) ? e.extend(!0, {}, e.fn.api.settings, r) : e.extend({}, e.fn.api.settings),
                     h = v.namespace,
                     y = v.metadata,
                     R = v.selector,
                     q = v.error,
                     ...
                     A = e(this),
                     S = A.closest(R.form),
                     j = v.stateContext ? e(v.stateContext) : A,
                     P = this,
                     w = j[0],
                     D = A.data(T);
                 b = {
                     ...
                     query: function() {
                         ...
                         }, v.throttle)) : (b.debug("Sending request", m, s.method), b.send.request(), b.timer = setTimeout(function() {}, v.throttle)) : (b.debug("Sending request", m, s.method), b.send.request()))) : void 0) : void b.error(q.missingURL))
                     },
                     should: {
                     ...
                     add: {
                         urlData: function(t, r) {
                             ...
                             return t && (o = t.match(v.regExp.required), s = t.match(v.regExp.optional), r = r || v.urlData, o && (b.debug("Looking for required URL variables", o), e.each(o, function(o, s) {
                                 var a = -1 !== s.indexOf("$") ? s.substr(2, s.length - 3) : s.substr(1, s.length - 2),
                                     i = e.isPlainObject(r) && r[a] !== n ? r[a] : A.data(a) !== n ? A.data(a) : j.data(a) !== n ? j.data(a) : r[a];
                         ...
                         formData: function(t) {
                             var r, o = e.fn.serializeObject !== n,
                                 s = o ? S.serializeObject() : S.serialize();
                         ...
                         xhr: {
                             always: function() {},
                                 ...
                                 var o = this,
                                     ...
                                     i = e.isFunction(v.onResponse) ? v.onResponse.call(o, e.extend(!0, {}, t)) : !1;
                         ...
                         request: {
                             ...
                             fail: function(e, t, r) {
                                 var o = b.get.responseFromXHR(e),
                                     a = b.get.errorFromRequest(o, t, r);
                     ...
                     create: {
                         ...
                         mockedXHR: function() {
                             var t, r, n, o = !1,
                                 s = !1,
                                 a = !1;
                             return n = e.Deferred().always(b.event.xhr.complete).done(b.event.xhr.done).fail(b.event.xhr.fail), v.mockResponse ? (e.isFunction(v.mockResponse) ? (b.debug("Using mocked callback returning response", v.mockResponse), r = v.mockResponse.call(w, v)) : (b.debug("Using specified response", v.mockResponse), r = v.mockResponse), n.resolveWith(w, [r, o, {
                                 responseText: r
                             }])) : e.isFunction(v.mockResponseAsync) && (t = function(e) {
                                 b.debug("Async callback returned response", e), e ? n.resolveWith(w, [e, o, {
                                     responseText: e
                                 }]) : n.rejectWith(w, [{
                                     responseText: e
                                 }, s, a])
     ...
     ! function(e, n, t, i) {
         ...
         e.fn.checkbox = function(t) {
             ...
             return a.each(function() {
                 var a, b, g = e.extend(!0, {}, e.fn.checkbox.settings, t),
                     h = g.className,
                     m = g.namespace,
                     f = g.selector,
                     p = g.error,
                 ...
                 b = {
                     ...
                     setting: function(n, t) {
                         if (b.debug("Changing setting", n, t), e.isPlainObject(n)) e.extend(!0, g, n);
                         else {
                             if (t === i) return g[n];
                             g[n] = t
                         }
                     ...
                     invoke: function(n, t, a) {
                         ...
                         return t = t || u, a = O || a, "string" == typeof n && s !== i && (n = n.split(/[\. ]/), c = n.length - 1, e.each(n, function(t, o) {
                             ...
                             if (e.isPlainObject(s[a]) && t != c) s = s[a];
                             else {
