define(function(require, exports, module) {
	...
	$(document).on('click','.J_export',function(event){
		...
		currentUrl = common.rootPath+'metadata/company.htm?m=exportDatadetails&code='+code+"&dbcode="+dbcode+"&flcode="+flcode+"&regcode="+regcode+"&datasource="+datasource+'&dbcodename='+dbcodename +"&flcodename="+flcodename +"&regcodename="+regcodename+"&datasourcename="+datasourcename+"&codename="+codename;
	...
	$(document).on('change','#database',function(event){
		...
		reqUrl = common.rootPath+'metadata/company.htm?m=getOtherSel&code='+code+"&dbcode="+sortVal+"&flag=1";
		var flag = false;
		$.ajax({
			url:reqUrl,
			type:'post',
		...
		if(flag){
			...
			regcode = $("#region").children('option:selected').val(),
			datasource = $("#datasource").children('option:selected').val(),
			currentUrl = common.rootPath+'metadata/company.htm?m=toDatadetails&code='+code+"&dbcode="+sortVal+"&flcode="+flcode+"&regcode="+regcode+"&datasource="+datasource;
			$.ajax({
				url:currentUrl,
				type:'post',
				dataType:'json',
	...
	$(document).on('change','#zbclass',function(event){
		...
		sortVal = $(this).children('option:selected').val(),
		dbcode = $("#database").children('option:selected').val(),
		reqUrl = common.rootPath+'metadata/company.htm?m=getOtherSel&code='+code+"&dbcode="+dbcode+"&flcode="+sortVal+"&flag=2";
		var flag = false;
		$.ajax({
			url:reqUrl,
			type:'post',
		...
		if(flag){
			...
			datasource = $("#datasource").children('option:selected').val(),
			currentUrl = common.rootPath+'metadata/company.htm?m=toDatadetails&code='+code+"&dbcode="+dbcode+"&flcode="+sortVal+"&regcode="+regcode+"&datasource="+datasource;
			$.ajax({
				url:currentUrl,
				type:'post',
				dataType:'json',
	...
	$(document).on('change','#region',function(event){
		...
		flcode = $("#zbclass").children('option:selected').val(),
		sortVal = $(this).children('option:selected').val(),
		reqUrl = common.rootPath+'metadata/company.htm?m=getOtherSel&code='+code+"&dbcode="+dbcode+"&flcode="+flcode+"&regcode="+sortVal+"&flag=3";
		var flag = false;
		$.ajax({
			url:reqUrl,
			type:'post',
		...
		if(flag){
			...
			currentUrl = common.rootPath+'metadata/company.htm?m=toDatadetails&code='+code+"&dbcode="+dbcode+"&flcode="+flcode+"&regcode="+sortVal+"&datasource="+datasource;
			$.ajax({
				url:currentUrl,
				type:'post',
				dataType:'json',
	...
	$(document).on('change','#datasource',function(event){
		...
		regcode = $("#region").children('option:selected').val(),
		sortVal = $(this).children('option:selected').val(),
		currentUrl = common.rootPath+'metadata/company.htm?m=toDatadetails&code='+code+"&dbcode="+dbcode+"&flcode="+flcode+"&regcode="+regcode+"&datasource="+sortVal;
		$.ajax({
			url:currentUrl,
			type:'post',
			dataType:'json',
